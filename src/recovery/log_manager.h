...
public:
    ...
    void format_print() override {
        std::cout << "log type in CommitLogRecord: " << LogTypeStr[log_type_] << "\n";
        LogRecord::format_print();
    }
};
...
public:
    ...
    void format_print() override {
        std::cout << "log type in AbortLogRecord: " << LogTypeStr[log_type_] << "\n";
        LogRecord::format_print();
    }
};
...
public:
    ...
    void format_print() override {
        std::cout << "log type in CheckpointLogRecord: " << LogTypeStr[log_type_] << "\n";
        LogRecord::format_print();
    }
};
